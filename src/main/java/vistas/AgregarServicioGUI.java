...
public class AgregarServicioGUI extends javax.swing.JFrame {

    ImagenFondo fondo = new ImagenFondo();
    
    public AgregarServicioGUI() {
    ...
    private void initComponents() {
        ...
        lblReferencia1.setText("Nombre Servicio Medico");
        ...
        btnAgendar.setText("Agregar Servicio Medico");
